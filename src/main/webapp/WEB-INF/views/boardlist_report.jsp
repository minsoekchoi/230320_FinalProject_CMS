...
<script src="resources/boardlist_report/js/radio_buttons.js"></script>
<link rel="stylesheet"
		...
		<div class="container_section">
			<div class="wrapper">
				<div id="wrapper_inner">
					...
					<h2 style="font-size: 30px; color: black;">신고내역리스트</h2>

					<div class="container_radio">
						<form class="container_radio_form">
					...
					<div style="text-align: right; width: 1200px; height: 50px;">
